...
public class BOTH_DRIVERS_23333_v2_2_PitchingSlides extends LinearOpMode {
    ...
    public static boolean clawLockTrue = false;
    ...
    public void runOpMode() throws InterruptedException {
        ...
        while (opModeIsActive()) {
            ...
            if (clawLockTrue) {
                telemetry.addData("⚠⚠⚠ Claw Lock", "True");
            } else {
                telemetry.addData("Claw Lock", "False");
            }
            telemetry.update();
        }
    }
